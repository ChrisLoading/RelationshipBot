...
def testIntent():
    # other
    print("[TEST] other")
    inputLIST = ['對方出軌','對方劈腿','對方外遇','男友出軌','男友劈腿','男友外遇','對方有炮友','對方好像出軌','對方好像劈腿','對方戴我綠帽','對方曾經約過炮','對方有兩支手機','對方腳踏兩條船','男友腳踏兩條船','對方不讓我看他賴','對方好像戴我綠帽','對方很多女生朋友','對方無法讓我信任','對方瞞著我開小帳','對方被我捉姦在床','對方不讓我看他LINE','對方不懂得劃清界線','對方不讓我看他手機','對方和前任藕斷絲連','對方和陌生人一夜情','對方好像腳踏兩條船','對方已經出軌好幾次','對方已經劈腿好幾次','對方會和其他人幽會','對方會載女同事回家','對方讓我沒有安全感','對方偷偷下載交友軟體','對方偷偷下載約炮軟體','對方和前女友藕斷絲連','對方愛和其他人搞曖昧','對方會和其他人搞曖昧','對方會讓女同事坐前座','對方會載女生朋友回家','對方還留著前任的東西','對方不能接受開放性關係','對方會讓女生朋友坐前座','對方和他前女友還有在連絡','對方會和其他人傳曖昧訊息','對方還留著他前女友的東西']
    testLoki(inputLIST, ['other'])
    print("")

    # self
    print("[TEST] self")
    inputLIST = ['我出軌','我劈腿','我被劈腿','我被戴綠帽','我好像被劈腿','我騙他我出軌','我騙他我劈腿','我好像被戴綠帽','我常常精神出軌','我戴我女友綠帽','我被腳踏兩條船','我騙他說我出軌','我騙他說我劈腿','我不想再原諒他了','我會載女同事回家','我和前女友只是朋友','我和前女友還有聯絡','我會讓女同事坐前座','我會載女生朋友回家','我沒辦法再相信他了','我還留著前任的東西','對方逼我封鎖我前女友','我會讓女生朋友坐前座','我無法克制自己不出軌','我無法克制自己不劈腿','我認為他不應該原諒我','我還留著前女友的東西','我只是不小心就滑進去了','我只是犯了全天下男人都會犯的錯']
