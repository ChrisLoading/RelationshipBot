...
def testIntent():
    ...
    # work
    print("[TEST] work")
    inputLIST = ['對方工時很長','老公每天加班','下班後不想被煩','下班後我不想被吵','下班後我只想放鬆','對方下班都不回家','老公回家都不下班','下班後我不想被女友吵','下班後我只想好好放鬆','老公下班都不知道去哪裡','下班回家只想一個人靜一靜','對方每天加班到很晚才回家']
...
if __name__ == "__main__":
    ...
    #resultDICT = execLoki("老公工時很長", filterLIST=filterLIST, refDICT=refDICT)                      # output => {"key": ["今天天氣"]}
