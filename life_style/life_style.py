...
def testIntent():
    ...
    # work
    print("[TEST] work")
    inputLIST = ['對方工時很長','老公每天加班','下班後不想被煩','下班我不想回家','下班後我不想被吵','下班後我只想放鬆','對方下班都不回家','老公回家都不下班','下班後我不想被女友吵','下班後我只想好好放鬆','男友下班都不知道去哪','老公下班都不知道去哪裡','下班回家只想一個人靜一靜','對方每天加班到很晚才回家']
