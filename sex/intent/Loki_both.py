...
def getResult(inputSTR, utterance, args, resultDICT, refDICT):
    ...
    if utterance == "[對方]做愛的[時候]好像變了[一個]人":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
    ...
    if utterance == "[對方]認為不跟[他]做愛就是不愛[他]":
        if CHATBOT_MODE:
            resultDICT["response"] = getResponse(utterance, args)
        else:
            # write your code here
