...
def testIntent():
    # family
    print("[TEST] family")
    inputLIST = ['婆媳問題','婆婆管太多','對方有家庭','被家人逼分手','對方家欠很多債','穩聊對象有家庭','家裡沒有任何房子','因為對方家庭而分手','因為父母反對就分手','因為父母反對想分手','婆婆很重視門當戶對','對方從小被媽媽家暴','對方有他的家人要顧','對方要我趕快生孩子','我不能接受他的家庭','雙方家庭背景差太多','家庭背景的關係想分手','對方原生家庭條件不好','對方媽媽的控制欲很強','因為對方家庭因素想分手','怎麼跟對方家人好好相處','家庭和價值觀跟我不太相符','家庭環境因素改變不了想分手']
