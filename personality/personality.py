...
def testIntent():
    # trait
    print("[TEST] trait")
    inputLIST = ['天天發牢騷','對方很小氣','對方愛計較','對方提分手','對方超囉嗦','對方超煩人','對方超黏我','男友很小氣','付出勝過對方','對方個性不好','對方個性小氣','對方像老媽子','對方很愛聊天','對方超級麻煩','對方超級黏我','對方佔有慾極強','對方很喜歡抱怨','對方很愛聊八卦','對方愛管東管西','我們相處得好累','男友占有慾很強','對方什麼都做不好','對方對我超級依賴','對方根本不了解我','對方總是心不在焉','我付出得比對方多','我和男友三觀不合','跟對方價值觀不合','女友有很強的佔有慾','對方和我興趣不一樣','對方有老媽子的特質','覺得自己什麼都不好','在一起時心情無比沮喪','對方很愛聊有的沒有的','我們很多方面都不太合','跟對方價值觀背道而馳','跟男友價值觀背道而馳','對方對每個細節都很在意','對方和我喜歡做的事不一樣','越來越容易看到對方的缺點','自己在各個方面都做得不太好','對方什麼事情都要跟我斤斤計較','我在這段感情中貢獻的比對方多','與對方交往讓我感到非常不舒適']
    testLoki(inputLIST, ['trait'])
    print("")

    # fight
    print("[TEST] fight")
    inputLIST = ['對方嘴臭','吵架吵個沒完','對方囉囉嗦嗦','對方感情勒索','對方說個不停','對方讓人頭痛','男友囉囉嗦嗦','對方特別喜歡抱怨','對方經常愛發牢騷','對方總是口出狂言','對方動不動就爆粗口','對方常對我冷嘲熱諷','我們常常因小事而爭吵','我們經常為了小事爭吵','在對方身邊讓我覺得非常煩躁','對方總是用傷人的話語來挑釁','小事常常引起我們之間的爭吵','吵架的時候對方老愛講難聽的話','對方常常使用激烈的詞句來侮辱我']
