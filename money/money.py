...
def testIntent():
    # money
    print("[TEST] money")
    inputLIST = ['偷家裡的錢','對方沒房沒車','對方說房租要AA','同居還不付房租','對方錢賺得很少','月入只有2萬出頭','月收入只有2萬多','他真的都沒在存錢','因為經濟能力分手','因為經濟能力自卑','對方什麼都要我付錢','對方出門都不帶錢包','對方經濟條件很普通','我賺的是我男友兩倍','因為經濟問題想提分手','跟對方的經濟非常懸殊','感情都是建立在金錢關係上','沒辦法回送金額相當的禮物','覺得我是一直花他錢的女生','不想讓對方覺得都是他在負擔','勸對方不要花費超過自己經濟能力','有一定的經濟能力才能給對方好的未來']
